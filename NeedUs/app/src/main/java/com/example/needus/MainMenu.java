...
public class MainMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] tile = {R.drawable.titles, R.drawable.title, R.drawable.title1, R.drawable.title2, R.drawable.title3, R.drawable.title4};
        FoodAdapter f = new FoodAdapter(this, s2, food, menu1, menu2, menu3, s1b, s2b, s3b, tile);
        rv2.setAdapter(f);
