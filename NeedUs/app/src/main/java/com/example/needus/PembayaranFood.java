...
public class PembayaranFood extends AppCompatActivity {
    ImageView imgback, gmMenu1, gmMenu2, gmMenu3, tlimg;
    TextView tmenu1, tmenu2, tmenu3;
    ConstraintLayout cl;
    String text1, text2, text3;
    int menu1, menu2, menu3, titles;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tlimg = findViewById(R.id.titleImg);
        getData();
        setData();
    ...
    private void getData(){
        if (getIntent().hasExtra("Menu1")&&getIntent().hasExtra("Menu2")&&getIntent().hasExtra("Menu3")&&getIntent().hasExtra("TextMenu1")&&getIntent().hasExtra("TextMenu2")&&getIntent().hasExtra("TextMenu3")&&getIntent().hasExtra("Title")){
            ...
            titles = getIntent().getIntExtra("Title", 1);
        }else{
